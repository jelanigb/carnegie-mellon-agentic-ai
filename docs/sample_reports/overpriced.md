...
**Every row compounds the same modelled rent, and that rent carries an error of ± $343/mo in Chicago — about 16% of it.** The rows differ from each other in how the market moves; not one of them widens for how far the starting rent could be off. Read the spread between rows as the range of markets this deal could meet, not as the range this system's own rent figure could take.
...
| --- | --- | --- | --- | --- | --- |
| **Prices fall, rents hold** | +4.08%/yr (long-run average) | $2,630 | -4.80%/yr (weakest stretch) | $1,051,983 | **0.75** — outscored the pairings left out |
| **Rents stall, prices hold** | -1.03%/yr (weakest stretch) | $2,045 | +8.92%/yr (long-run average) | $2,062,119 | **0.70** — level with 2 other pairings, kept as the more cautious |
| **Neutral case** | +4.08%/yr (long-run average) | $2,630 | +8.92%/yr (long-run average) | $2,062,119 | **0.90** — outscored the pairings left out |
...
- **Neutral case** — Both rent and price use median growth rates backed by the largest number of observations, making them highly defensible.
