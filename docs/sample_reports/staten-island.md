...
>
> 🚩 **Flagged by system — needs human review before sharing with investors.** This deal did not clear the system's automated checks on its own; the disclosures below say why. **This is a statement about the evaluation, not about the property.**
>
...
**Every row compounds the same modelled rent, and that rent carries an error of ± $855/mo in New York — about 32% of it.** The rows differ from each other in how the market moves; not one of them widens for how far the starting rent could be off. Read the spread between rows as the range of markets this deal could meet, not as the range this system's own rent figure could take.
...
| --- | --- | --- | --- | --- | --- |
| **Rents stall, prices fall** | +3.93%/yr (weakest stretch) | $3,218 | +1.32%/yr (weakest stretch) | $934,077 | **0.85** — outscored the pairings left out |
| **Rents stall, prices hold** | +3.93%/yr (weakest stretch) | $3,218 | +5.61%/yr (long-run average) | $1,149,405 | **0.80** — outscored the pairings left out |
| **Neutral case** | +6.77%/yr (long-run average) | $3,682 | +5.61%/yr (long-run average) | $1,149,405 | **0.70** — the neutral case, always shown |
...
- **Neutral case** — Both bands represent moderate growth levels that are observed across the series and are not flagged as unreliable.
...
*Generated by the multi-family deal evaluator · run started 2026-09-02 11:18 · planner invocations 1 · rework passes 0*
