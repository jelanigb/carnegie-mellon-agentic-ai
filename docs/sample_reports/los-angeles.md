...
>
> ✅ **Cleared by system — no human review needed before sharing.** The figures below passed the system's own checks without a human having to release them.
...
At the modelled rent, this property's gross rent is **$68,663 a year** across 2 units, so the asking price is **15.3×** annual gross rent.

The typical recorded sale in this metro area would buy the same rent at **15.3×**. That is the *same* comparison as the price-versus-benchmark figure above rather than a second one — both multiples divide by the same rent, so the gap between them is the price gap restated. It is shown because the multiple is the unit this comparison is usually made in.
...
**Every row compounds the same modelled rent, and that rent carries an error of ± $509/mo in Los Angeles — about 18% of it.** The rows differ from each other in how the market moves; not one of them widens for how far the starting rent could be off. Read the spread between rows as the range of markets this deal could meet, not as the range this system's own rent figure could take.
...
| Scenario | Rent growth | Rent in year 5 | Price growth | Price in year 5 | Why this row is shown |
| --- | --- | --- | --- | --- | --- |
| **Prices fall, rents hold** | +2.51%/yr (long-run average) | $3,239 | -0.80%/yr (weakest stretch) | $1,007,894 | **0.85** — level with 3 other pairings, kept as the more cautious |
| **Rents stall, prices hold** | +1.25%/yr (weakest stretch) | $3,045 | +2.10%/yr (long-run average) | $1,164,118 | **0.85** — level with 3 other pairings, kept as the more cautious |
| **Neutral case** | +2.51%/yr (long-run average) | $3,239 | +2.10%/yr (long-run average) | $1,164,118 | **0.96** — outscored the pairings left out |
...
- **Neutral case** — Both rent and price use central historical growth rates that are directly observed and therefore most robustly founded.
...
*Generated by the multi-family deal evaluator · run started 2026-09-02 11:17 · planner invocations 1 · rework passes 0*
