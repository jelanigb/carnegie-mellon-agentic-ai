...
| [`task_list_u9.md`](task_list_u9.md) | U9 — report, recommendation, and the demo surface | ✅ closed Sept 2, 2026 with **U9.9's capture** as its one gap, **discharged Sept 7, 2026** — live runs, LangSmith traces and surface screenshots against the frozen build, closing OQ-13. Planned as "Summarizer polish + a Streamlit app" and rewritten after one real run |
