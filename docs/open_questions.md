...
**Left open on purpose, and closed Sept 7, 2026: OQ-13.** It was the one thing U9 owed and
did not deliver, because the capture needed a live account and a screen rather than any code.
Traces were captured against the shipped surface on Sept 7 and the entry is closed; the
durable artifact is the screenshot in the README's *Observability* section, since free-tier
traces expire after 14 days.
