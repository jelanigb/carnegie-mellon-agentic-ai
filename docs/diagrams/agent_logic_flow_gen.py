...
forecast = stack(
    [
        ...
        stage("RECONCILE", "order by outcome; name each row from its two bands"),
...
summarizer = stack(
    [
        ...
        stage("REASON", "take stock of what the run established and what it did not"),
        stage("ACT", "render escalation, findings, comp evidence (disclosure-first)"),
        stage("DECIDE", "close the run; a reviewed deal keeps its reviewed status"),
